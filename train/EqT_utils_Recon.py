...
class DataGenerator(tensorflow.keras.utils.Sequence):
    ...
    def __getitem__(self, index):
        ...
        return ({'input': X}, {'reconstruction': y2})
    ...
    def __data_generation(self, list_IDs_temp):
        ...
        xin = np.zeros((self.batch_size, self.dim, self.n_channels))
        ...
        for i, ID in enumerate(list_IDs_temp):
            ...
            m = np.random.randint(1,300)
            a = np.ones(3000, dtype=int)
            a[:m] = 0
            np.random.shuffle(a)
            df0[0:3000]= df0[0:3000]*a
            df1[0:3000]= df1[0:3000]*a
            df2[0:3000]= df2[0:3000]*a

            df0[3000:]= df0[3000:]*np.flip(a)
            df1[3000:]= df1[3000:]*np.flip(a)
            df2[3000:]= df2[3000:]*np.flip(a)
            ...
            # Time Mask
            m = np.random.randint(1,600)
            a = np.ones(6000, dtype=int)
            a[:m] = 0
            np.random.shuffle(a)
...
class DataGeneratorTest_Coruppted(keras.utils.Sequence):
